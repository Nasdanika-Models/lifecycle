 ...
 * @generated
 */
public class LifecycleSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LifecyclePackage.LIFECYCLE: {
				Lifecycle lifecycle = (Lifecycle)theEObject;
				T result = caseLifecycle(lifecycle);
				if (result == null) result = caseSealedElement(lifecycle);
				if (result == null) result = caseAccessControlled(lifecycle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LifecyclePackage.STAGE: {
				Stage stage = (Stage)theEObject;
				T result = caseStage(stage);
				if (result == null) result = caseSealedElement(stage);
				if (result == null) result = caseAccessControlled(stage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LifecyclePackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = caseSealedElement(transition);
				if (result == null) result = caseAccessControlled(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LifecyclePackage.SOJOURN: {
				Sojourn sojourn = (Sojourn)theEObject;
				T result = caseSojourn(sojourn);
				if (result == null) result = caseSealedElement(sojourn);
				if (result == null) result = caseAccessControlled(sojourn);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LifecyclePackage.STAGED: {
				Staged staged = (Staged)theEObject;
				T result = caseStaged(staged);
				if (result == null) result = caseSealedElement(staged);
				if (result == null) result = caseAccessControlled(staged);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sojourn</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sojourn</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSojourn(Sojourn object) {
		return null;
	}
